...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BootstrapPod) DeepCopyInto(out *BootstrapPod) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootstrapPod.
func (in *BootstrapPod) DeepCopy() *BootstrapPod {
	if in == nil {
		return nil
	}
	out := new(BootstrapPod)
	in.DeepCopyInto(out)
	return out
}
